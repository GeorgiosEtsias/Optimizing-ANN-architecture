...
It consists of a singe script GeneticAlgorithm.m and two functions called into the script Objective.m that is the objective function determining the optimum architectre and gaplotbestcustom.m a variation of the standard plotting algorithm used in matlab, coping with the heuristic anature of the objective function.The dataset DATA used to train the ANNs is also attached.
